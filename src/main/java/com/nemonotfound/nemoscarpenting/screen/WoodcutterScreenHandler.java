...
public class WoodcutterScreenHandler
    ...
    public WoodcutterScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        super(NemosCarpenting.WOODCUTTER_SCREEN_HANDLER, syncId);
        int i;
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(NemosCarpenting.WOODCUTTING, input, this.world);
        }
    }
    ...
    public ScreenHandlerType<?> getType() {
        return NemosCarpenting.WOODCUTTER_SCREEN_HANDLER;
    }
