...
public class ModItemGroups {
    ...
    private static void modifyFunctionalItemGroup() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(content -> {
            ...
            content.add(ModItems.ACACIA_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.BAMBOO_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.BIRCH_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.CHERRY_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.CRIMSON_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.DARK_OAK_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.JUNGLE_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.MANGROVE_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.OAK_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.SPRUCE_CHAIR_LUKAS_NATURAL);
            content.add(ModItems.WARPED_CHAIR_LUKAS_NATURAL);
