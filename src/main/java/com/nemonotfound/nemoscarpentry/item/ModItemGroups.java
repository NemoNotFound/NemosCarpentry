    ...
    private static void registerNemosCarpentryItemGroup(Item iconItem) {
        ItemGroup ITEM_GROUP = FabricItemGroup.builder()
                ...
                .entries((context, entries) -> {
                    ...
                    entries.add(ModItems.ACACIA_TABLE_PASCAL);
                    entries.add(ModItems.BAMBOO_TABLE_PASCAL);
                    entries.add(ModItems.BIRCH_TABLE_PASCAL);
                    entries.add(ModItems.CHERRY_TABLE_PASCAL);
                    entries.add(ModItems.CRIMSON_TABLE_PASCAL);
                    entries.add(ModItems.DARK_OAK_TABLE_PASCAL);
                    entries.add(ModItems.JUNGLE_TABLE_PASCAL);
                    entries.add(ModItems.MANGROVE_TABLE_PASCAL);
                    entries.add(ModItems.OAK_TABLE_PASCAL);
                    entries.add(ModItems.SPRUCE_TABLE_PASCAL);
                    entries.add(ModItems.WARPED_TABLE_PASCAL);
