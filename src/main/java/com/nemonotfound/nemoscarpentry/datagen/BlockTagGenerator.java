...
public class BlockTagGenerator extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        getOrCreateTagBuilder(BlockTags.AXE_MINEABLE)
                ...
                .add(ModBlocks.ACACIA_TABLE_PASCAL)
                .add(ModBlocks.BAMBOO_TABLE_PASCAL)
                .add(ModBlocks.BIRCH_TABLE_PASCAL)
                .add(ModBlocks.CHERRY_TABLE_PASCAL)
                .add(ModBlocks.CRIMSON_TABLE_PASCAL)
                .add(ModBlocks.DARK_OAK_TABLE_PASCAL)
                .add(ModBlocks.JUNGLE_TABLE_PASCAL)
                .add(ModBlocks.MANGROVE_TABLE_PASCAL)
                .add(ModBlocks.OAK_TABLE_PASCAL)
                .add(ModBlocks.SPRUCE_TABLE_PASCAL)
                .add(ModBlocks.WARPED_TABLE_PASCAL)
