...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    private void createChairRecipes(Consumer<RecipeJsonProvider> exporter) {
    ...
    private void createCampfireRecipe(Consumer<RecipeJsonProvider> exporter, Block result, TagKey<Item> log) {
    ...
    private void createSoulCampfireRecipe(Consumer<RecipeJsonProvider> exporter, Block result, TagKey<Item> log) {
    ...
    private void createCarpentryRecipe(Consumer<RecipeJsonProvider> exporter, List<Pair<Block, Integer>> ingredients, Block output, int outputCount, String tool) {
    ...
    private void createCarpentryRecipeJson(Consumer<RecipeJsonProvider> exporter, Block block, Map<Block, Block> inputToOutputMap, int count, String tool) {
