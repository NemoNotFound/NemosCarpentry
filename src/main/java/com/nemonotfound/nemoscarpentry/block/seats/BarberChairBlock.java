...
public class BarberChairBlock extends SitableBlock implements Waterloggable {
    ...
    public BarberChairBlock(Settings settings) {
        super(settings, 0.45f, NORTH_SHAPE, EAST_SHAPE, SOUTH_SHAPE, WEST_SHAPE);
    }
}
