...
import com.nemonotfound.NemosFurniture;
...
extends ScreenHandler {
    ...
    public WoodcutterScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        super(NemosFurniture.WOODCUTTER_SCREEN_HANDLER, syncId);
        int i;
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(NemosFurniture.WOODCUTTING, input, this.world);
        }
    }
    ...
    public ScreenHandlerType<?> getType() {
        return NemosFurniture.WOODCUTTER_SCREEN_HANDLER;
    }
