...
//import com.nemonotfound.nemos.carpentry.property.ModProperties;
...
//                .of(block, createWeightedVariant(modelId)));
//    }
//
...
//
//        return VariantsBlockModelDefinitionCreator.of(benchBlock)
...
//        return variantMap.register(Direction.EAST, BenchPart.LEFT, createRotatedBlockStateVariant(leftBenchModelId, AxisRotation.R90))
//                .register(Direction.SOUTH, BenchPart.LEFT, createRotatedBlockStateVariant(leftBenchModelId, AxisRotation.R180))
//                .register(Direction.WEST, BenchPart.LEFT, createRotatedBlockStateVariant(leftBenchModelId, AxisRotation.R270))
//                .register(Direction.NORTH, BenchPart.LEFT, createBlockStateVariant(leftBenchModelId))
//                .register(Direction.EAST, BenchPart.RIGHT, createRotatedBlockStateVariant(rightBenchModelId, AxisRotation.R90))
//                .register(Direction.SOUTH, BenchPart.RIGHT, createRotatedBlockStateVariant(rightBenchModelId, AxisRotation.R180))
//                .register(Direction.WEST, BenchPart.RIGHT, createRotatedBlockStateVariant(rightBenchModelId, AxisRotation.R270))
...
//        return blockStateVariantMap.register(Direction.EAST, createRotatedBlockStateVariant(modelId, AxisRotation.R90))
//                .register(Direction.SOUTH, createRotatedBlockStateVariant(modelId, AxisRotation.R180))
//                .register(Direction.WEST, createRotatedBlockStateVariant(modelId, AxisRotation.R270))
//                .register(Direction.NORTH, createBlockStateVariant(modelId));
//    }
//
//    private static BlockStateVariant createRotatedBlockStateVariant(Identifier modelId, AxisRotation rotation) {
