...
public class NemosFurnitureClient implements ClientModInitializer {

    @Override
    public void onInitializeClient() {
        HandledScreens.register(NemosFurniture.WOODCUTTER_SCREEN_HANDLER, WoodcutterScreen::new);
        ...
        EntityRendererRegistry.register(NemosFurniture.CHAIR_ENTITY, ChairEntityRenderer::new);
    }
}
